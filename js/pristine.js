!(function (e, r) {
	'object' == typeof exports && 'undefined' != typeof module
		...
		? define(r)
		: ((e = 'undefined' != typeof globalThis ? globalThis : e || self).Pristine = r())
})(this, function () {
	'use strict'
	var e = {
		en: {
			...
			minlength: 'Please enter ${1} or more characters',
	...
	function f(t, s, u) {
		...
		function d(e) {
			var r = m(e),
				t = r[0],
				n = r[1]
			t && (t.classList.remove(f.config.successClass), t.classList.add(f.config.errorClass)),
				n && ((n.innerHTML = e.errors.join('<br/>')), (n.style.display = n.pristineDisplay || ''))
		}
		function h(e) {
			var r = (function (e) {
				var r = m(e),
					...
					n = r[1]
				return (
					t && (t.classList.remove(f.config.errorClass), t.classList.remove(f.config.successClass)),
		...
		return (
			(function (e, r, t) {
				e.setAttribute('novalidate', 'true'),
					...
					(f.live = !(!1 === t)),
					(f.fields = Array.from(
						e.querySelectorAll('input:not([type^=hidden]):not([type^=submit]), select, textarea')
					).map(
						function (e) {
							var r = [],
								t = {},
							...
							return (
									...
									if (/^data-pristine-/.test(e.name)) {
										...
										if (null !== o) {
											...
											return (
												...
												void (n[l][s.slice(0, s.length - o[0].length)] = e.value)
											)
										}
								...
								(e.pristine = { input: e, validators: r, params: t, messages: n, self: f })
							)
						}.bind(f)
					))
			})(t, s, u),
			...
			(f.addValidator = function (e, r, t, n, i) {
				e instanceof HTMLElement
					? (e.pristine.validators.push({ fn: r, msg: t, priority: n, halt: i }),
	...
	return (
		...
		u('min', {
			fn: function (e, r) {
				return (
					!e || ('checkbox' === this.type ? t(this) >= parseInt(r) : parseFloat(e) >= parseFloat(r))
				)
			},
		}),
		u('max', {
